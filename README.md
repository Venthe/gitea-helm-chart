...
| `actions.remoteInstanceUrl`                    | Connect to a remote instance of Gitea, in the event that you are using a separately hosted Gitea instance for self-hosted runners. Leave empty to disable. Values look like "<https://gitea.com/>" or "<http://192.168.8.8:3000/>" | `""`                           |
...
| Name                                         | Description                                                                                                                    | Value                |
| -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | -------------------- |
| `gitea.enabled`                              | Enable main Gitea server deployment. Set this to false if you want to only deploy actions.                                     | `true`               |
